...
def get_dealerships(request):
    if request.method == "GET":
        context = {}
        url = "https://c5a157c1-d3c0-4b06-a3f3-3eaf2675370a-bluemix.cloudantnosqldb.appdomain.cloud/dealerships"
...
def get_dealer_details(request, dealer_id):
    context = {}
    if request.method == "GET":
        url = 'https://c5a157c1-d3c0-4b06-a3f3-3eaf2675370a-bluemix.cloudantnosqldb.appdomain.cloud/api/review'
...
def add_review(request, dealer_id):
    ...
    if request.user.is_authenticated:
        ...
        if request.method == "GET":
            url = f"https://c5a157c1-d3c0-4b06-a3f3-3eaf2675370a-bluemix.cloudantnosqldb.appdomain.cloud/dealerships/dealer-get?dealerId={dealer_id}"
        ...
        if request.method == "POST":
            ...
            url = "https://c5a157c1-d3c0-4b06-a3f3-3eaf2675370a-bluemix.cloudantnosqldb.appdomain.cloud/api/review"  # API Cloud Function route
